...
$config['db_database'] = "dna_thealest";
$config['db_username'] = "dna_desarrollo";
$config['db_password'] = 'LLUq5vX2F$2^';

// emails
$config['email_address'] = "dev@wearedna.studio"; // info@thealest.com
...
// recaptcha
$config['recaptchaPublic'] = '6LdJMAoUAAAAACDZ5V45cQXRlrtw3Xz8UeXluz_r';
$config['recaptchaSecret'] = '6LdJMAoUAAAAAKSc1QL3twKE-RaMAfK85xgyOVAG';
