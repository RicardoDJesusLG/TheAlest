...
$config['db_database'] = "web8755"; <----Colocar su nombre de base de datos de mysql
$config['db_username'] = "root";  <---colocar su usuario de mysql si es diferente a root
$config['db_password'] = ""; <---Colocar su contraseña de mysql

LUEGO SE LE DEBE CAMBIAR DE NOMBRE A ESTE ARCHIVO DE 
